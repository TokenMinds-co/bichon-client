...
const schema = z.object({
  ...
  message: z.string().min(50, 'Message must be at least 50 characters').max(1000, 'Message must not exceed 1000 characters'),
  attachments: z
    .array(
      z.object({
        file: z
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 max-w-2xl mx-auto p-6 bg-white rounded-lg shadow">
      ...
      <div className="space-y-2">
        ...
        <Textarea id="message" {...register('message')} className="min-h-[100px]" />
